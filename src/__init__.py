...
# allowed_range = {
#     "1m": ["1m", "1min", 1, 1], "2m":  ["1m", "2min", 2, 2], "3m":  ["1m", "3min", 3, 3],
#     "4m": ["1m", "4min", 4, 4], "5m": ["1m", "5min", 5, 5], "6m": ["1m", "6min", 6, 6],
#     "7m": ["1m", "7min", 7, 7], "8m": ["1m", "8min", 8, 8], "9m": ["1m", "9min", 9, 9],
#     "10m": ["1m", "10min", 10, 10], "11m": ["1m", "11min", 11, 11],
#     "15m": ["5m", "15min", 3, 15], "30m": ["5m", "30min", 6, 30], "45m": ["5m", "45min", 9, 45],
...
allowed_range = {
    "1m": ["1m", "1min", 1, 1], "2m":  ["1m", "2min", 2, 2], "3m":  ["1m", "3min", 3, 3],
    "4m": ["1m", "4min", 4, 4], "5m": ["5m", "5min", 1, 5], "6m": ["1m", "6min", 6, 6],
    "7m": ["1m", "7min", 7, 7], "8m": ["1m", "8min", 8, 8], "9m": ["1m", "9min", 9, 9],
    "10m": ["5m", "10min", 2, 10], "11m": ["1m", "11min", 11, 11],
    "15m": ["15m", "15min", 1, 15], "30m": ["15m", "30min", 2, 30], "45m": ["15m", "45min", 3, 45],
    "1h": ["1h", "1h", 1, 1], "2h":  ["1h", "2h", 2, 2],
    "3h": ["1h", "3h", 3, 3], "4h":  ["4h", "4h", 1, 4],
    "6h": ["6h", "6h", 1, 6], "12h": ["6h", "12h", 2, 12],
    "1d": ["1d", "1D", 1, 1], "3d": ["3d", "3D", 3, 3]
    # not support yet '1w', '2w', '1M'
}

bybit_allowed_range = {
    "1m": ["1", "1min", 1, 1], "2m":  ["1", "2min", 2, 2], "3m":  ["1", "3min", 3, 3],
    "4m": ["1", "4min", 4, 4], "5m": ["1", "5min", 5, 5], "6m": ["1", "6min", 6, 6],
    "7m": ["1", "7min", 7, 7], "8m": ["1", "8min", 8, 8], "9m": ["1", "9min", 9, 9],
    "10m": ["1", "10min", 10, 10], "11m": ["1", "11min", 11, 11],
    "15m": ["5", "15min", 3, 15], "30m": ["5", "30min", 6, 30], "45m": ["5", "45min", 9, 45],
...
allowed_range_minute_granularity = {
    ...
    "7m": ["1m", "7min", 7, 7], "8m": ["1m", "8min", 8, 8], "9m": ["1m", "9min", 9, 9],
    "10m": ["1m", "10min", 10, 10], "11m": ["1m", "11min", 11, 11],
    "15m": ["1m", "15min", 15, 15], "30m": ["1m", "30min", 30, 30], "45m": ["1m", "45min", 45, 45],
    "1h": ["1m", "60min", 60, 60], "2h":  ["1m", "120min", 120, 120],
    "3h": ["1m", "180min", 180, 180], "4h":  ["1m", "240min", 240, 240],
    "6h": ["1m", "360min", 360, 360], "12h": ["1m", "720min", 720, 720],
    "1d": ["1m", "1440min", 1440, 1440], "3d": ["1m", "4320min", 4320, 4320]
    # not support yet '1w', '2w', '1M'
}
